...
export const SKILLS: Record<SkillNames, Skill> = {
  [SkillNames.GITLAB]: {
    ...
    name: "gitlab",
    label: "Gitlab",
    shortDescription: "• CI/CD Pipelines\n• Source Code Mgmt\n• DevSecOps Integration",
    color: "#f0db4f",
  ...
  [SkillNames.FIREBASE]: {
    ...
    name: "firebase",
    label: "Firebase",
    shortDescription: "• Real-time Databases\n• Authentication & AuthZ\n• Serverless Functions",
    color: "#e34c26",
  ...
  [SkillNames.BASH]: {
    ...
    shortDescription: "• Shell Automation\n• System Administration\n• Pipeline Scripting",
    color: "#61dafb",
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "• Automation & Scripting\n• Data Processing & ML\n• Backend Integration",
    color: "#61dafb",
  ...
  [SkillNames.ANSIBLE]: {
    ...
    name: "ansible",
    label: "Ansible",
    shortDescription: "• Config Management\n• Infra Automation\n• Agentless Orchestration",
    color: "#38bdf8",
  ...
  [SkillNames.NODEJS]: {
    ...
    name: "nodejs",
    label: "Node.js",
    shortDescription: "• Non-blocking I/O\n• RESTful & GraphQL APIs\n• Real-time Applications",
    color: "#6cc24a",
  ...
  [SkillNames.MONGODB]: {
    ...
    name: "mongodb",
    label: "MongoDB",
    shortDescription: "• NoSQL Document Store\n• Schema Flexibility\n• Horizontal Scaling",
    color: "#336791",
  ...
  [SkillNames.GITHUB]: {
    ...
    name: "github",
    label: "GitHub",
    shortDescription: "• Pull Request Workflows\n• GitHub Actions CI/CD\n• Code Reviews",
    color: "#000000",
  ...
  [SkillNames.NPM]: {
    ...
    name: "npm",
    label: "NPM",
    shortDescription: "• Package Management\n• Dependency Resolution\n• Script Automation",
    color: "#fff",
  ...
  [SkillNames.LINUX]: {
    ...
    name: "linux",
    label: "Linux",
    shortDescription: "• Server Administration\n• Resource Management\n• Security Permissions",
    color: "#fff",
  ...
  [SkillNames.NGINX]: {
    ...
    name: "nginx",
    label: "NginX",
    shortDescription: "• Reverse Proxy\n• Web Server Config\n• Load Balancing",
    color: "#008000",
  ...
  [SkillNames.VIM]: {
    ...
    name: "vim",
    label: "Vim",
    shortDescription: "• Terminal Text Editing\n• File Navigation\n• System Configuration",
    color: "#e34c26",
