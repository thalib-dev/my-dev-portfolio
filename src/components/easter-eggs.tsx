  ...
  useEffect(() => {
    ...
    if (typeof console !== "undefined") {
      ...
      console.log(
        ...
        "Just type %cmy second name%c and hit enter! 🎩🐇",
      ...
      ["thalib", "Thalib", "THALIB"].forEach((name) => {
        // @ts-ignore
        ...
        Object.defineProperty(window, name, {
          get() {
            console.log(
              "%c✨ Abra Kadabra! ✨\n\n" +
              "You just summoned the magic of Thalib! 🧙‍♂️\n" +
            ...
            const timer = setTimeout(() => {
              console.log(
                "%cPssttt! 🤫\n\n" +
                "Do you like luffy?? 👒 If yes, then press 'n' on viewport and see what happens! ✨",
